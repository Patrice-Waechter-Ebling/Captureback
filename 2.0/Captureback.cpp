...
HBITMAP hbmScreen,bmp,hbmScaled,hbmp;
BITMAP btmp;
HMENU mnu;
SYSTEMTIME st;
...
BITMAPV5HEADER bmp5h;
BITMAPINFOHEADER bmpinfh;
BITMAPINFO bmpinf;
RGBQUAD rgbquad;
//Tableaux
...
void CaptureEcran(HWND hDlg);
void SysMenu(HWND hDlg);
	...
	case WM_COMMAND:
		switch (LOWORD(wParam)) {
			case IDOK:
				...
				break;
			case IDC_BUTTON1:
				CommunFichiers("Charger une image","Images Bitmap\0*.bmp\0\0");
...
VOID APIENTRY DisplayContextMenu(POINT pt) {
